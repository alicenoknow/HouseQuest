...
type LoadingAction = { type: LoadingActionType.CHANGE_STATE, isLoading: boolean };
...
const LoadingContext = createContext<LoadingContextProps>({ state: initialState, dispatch: () => { } });
