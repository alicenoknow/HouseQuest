...
function reducer(state: TaskState, action: TaskAction) {
  ...
  switch (action.type) {
    case TaskActionType.ADD: {
      return {
        ...state,
        tasks: [...tasks.filter((t) => t.id != action.task.id), action.task]
      };
    }
    ...
    case TaskActionType.ASSIGN: {
      ...
      if (toChange) {
        return {
          ...
          tasks: [
            ...unchanged,
            { ...toChange, assignee: user, status: TaskStatus.ASSIGNED }
          ]
        };
      }
      return state;
    ...
    case TaskActionType.UNASSIGN: {
      ...
      if (toChange) {
        return {
          ...
          tasks: [
            ...unchanged,
            { ...toChange, assignee: undefined, status: TaskStatus.UNASSIGNED }
          ]
        };
      }
      return state;
    ...
    case TaskActionType.CONFIRM: {
      ...
      if (toChange) {
        return {
          ...state,
          tasks: [...unchanged, { ...toChange, status: TaskStatus.CONFIRMED }]
        };
      }
      return state;
    }
    case TaskActionType.DECLINE: {
      ...
      if (toChange) {
        return {
          ...state,
          tasks: [...unchanged, { ...toChange, status: TaskStatus.ASSIGNED }]
        };
      }
      return state;
    }
